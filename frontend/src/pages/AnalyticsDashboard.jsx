      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-xl text-sm text-[var(--muted)]">
            ...
            (default), recent activity includes all users’ latest rows; the User column shows a short id suffix. ihdhdiddidiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii
          </p>
        </div>
        <button
          type="button"
